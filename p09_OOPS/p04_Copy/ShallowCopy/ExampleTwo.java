...
public class ExampleTwo {
    public static void main(String[] args) {
        ...
        System.out.println(original.name == shallowCopy.name); // true

        shallowCopy.name = "Raj"; // Since string is immutable -> creates a NEW String object, original untouched
        
        System.out.println(original.name == shallowCopy.name); // false
        ...
        System.out.println(original2.name == shallowCopy2.name); // true
